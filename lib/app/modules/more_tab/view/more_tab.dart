...
class MoreTabScreen extends GetView<SettingController> {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AppText('more_tab'.tr,color: Colors.white,fontSize: 18,),
                                SizedBox()
                              ],
                            ),
                            Container(
                                ...
                                shape: RoundedRectangleBorder(
                                 ...
                                 child:Padding(
                                   ...
                                   child: Column(
                                     children: [
                                       SizedBox(height: 40,),
                                       buildSettingWidget('change_password'.tr,1,context),
                                       SizedBox(height: 20,),
  ...
  buildSettingWidget(String txt,int flag,BuildContext context){
    return   InkWell(
      onTap:(){
        flag==1?showChangeLangDialog(context):null;
      } ,
      child: SizedBox(
        height: 80,
        child: Card(
          ...
          child: Row(
            ...
            children: [
              ...
              Icon(Icons.forward,color: kPurpleColor,)
            ],
          ),
        ),
      ),
  ...
  void showChangeLangDialog(BuildContext context) {
    showDialog(context: context, builder: (ctx)=>
        GetBuilder<SettingController>(
          builder: (_)=>
              AlertDialog(
                title: Center(child: AppText('change_lang'.tr,color:kPrimaryColor,)),
                content:Container(
                                  ...
                                  SizedBox(
                                    ...
                                    child: RaisedButton(
                                      ...
                                      onPressed: (){
                                        ...
                                        child: AppText('العربيه',color: Colors.white,)),),
                                  ),
                                  SizedBox(height: 15,),
                                  SizedBox(
                                    height: 40,
                                    ...
                                    child: RaisedButton(
                                      ...
                                      },child: AppText('English',color: Colors.white,),),
                                  ),
                                ],
                              ),
                        ),
